...
cd pharo-vm-c-src
wget https://files.pharo.org/vm/pharo-spur64-headless/Windows-x86_64/source/PharoVM-10.0.9-79fe4f32-Windows-x86_64-c-src.zip
unzip PharoVM-10.0.9-79fe4f32-Windows-x86_64-c-src.zip
cd ../
