...
static char __buildInfo[] = "ChickenSchemePlugin VMMaker.oscog-eem.2495 uuid: fcbf4c90-4c50-4ff3-8690-0edfded4f9c4 " __DATE__;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"ChickenSchemePlugin VMMaker.oscog-eem.2495 (i)"
#else
	"ChickenSchemePlugin VMMaker.oscog-eem.2495 (e)"
#endif
	;
...
EXPORT(sqInt)
primitive_CHICKEN_run(void)
{
	long r = CHICKEN_run(CHICKEN_default_toplevel);

	if (!(interpreterProxy->failed()))
	{
		interpreterProxy->popthenPush(1, interpreterProxy->signed64BitIntegerFor(r));
	}
